...
class Main(QMainWindow):
    ...
    def initUI(self):
        ...
        # SEND MESSAGE TEXT TO THE ARDUINO TO ENCODE
        ...
        # RECORD BUTTON TO RECORD INCOMING MESSAGE AND THEN TO STOP RECORDING
        self.Record = QPushButton("Start Recording")
        self.Record.clicked.connect(self.toggle_recording)
        self.Record.setStyleSheet("background-color:#f1ddbf;font-size: 18px;font-weight:700; border: 2px solid #413344; border-radius: 15px; margin: 0 10 0 10;")
        self.Record.setFixedSize(200,47)
        #TRANSLATE MORSE CODE TO TEXT AND DISPLAY IN RX WINDOW
        self.translate_code = QPushButton("Translate")
        self.translate_code.clicked.connect(self.receive_code)
        self.translate_code.setFixedSize(200,47)
        self.translate_code.setStyleSheet("background-color:#f1ddbf;font-size: 18px;font-weight:700; border: 2px solid #413344; border-radius: 15px; margin: 0 10 0 10;")
        ...
        button_layout.addWidget(self.Record)
        button_layout.addWidget(self.translate_code)
    ...
    def receive_code(self):
        ...
        decoding_results = decoder.decode_wav_file("output.wav")
